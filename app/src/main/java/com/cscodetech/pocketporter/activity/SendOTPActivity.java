...
import com.cscodetech.pocketporter.PolicyActivity;
...
public class SendOTPActivity extends AppCompatActivity implements GetResult.MyListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtMob.setText("We have sent you an SMS on \n" + user.getCcode() + " " + user.getMobile() + "\n with 6 digit verification code");
        try {
    ...
    public void bottonConfirm() {
        ...
        EditText edConfirmPass = sheetView.findViewById(R.id.ed_confirm_password);
        EditText edRefercode = sheetView.findViewById(R.id.ed_refercode);
        TextView txtChoose = sheetView.findViewById(R.id.btn_send);
        CheckBox CbCheckbox = sheetView.findViewById(R.id.checkBoxPolicy);
        TextView checkBoxText = sheetView.findViewById(R.id.checkBoxText);
        checkBoxText.setOnClickListener(v -> {
        ...
        txtChoose.setOnClickListener(v -> {
            if (edPassword.getText().toString().equals(edConfirmPass.getText().toString())){
                if (CbCheckbox.isChecked()) {
                    ...
                    Toast.makeText(this, "Please accept our policy.", Toast.LENGTH_SHORT).show();
                }
            }else {
